        ...
        <div class="dashboard">
                    <nav>
                        <div class="profile">
                            ...
                            <img src="https://localhost/assets/images/dashboardGate/avatar.svg" alt="avatar">
                    ...
                    <main>
                        <div class="listOfGames">
                            <div class="1v1">
                                ...
                                <h1> 1 Vs 1 </h1>
                                <img src="https://localhost/assets/images/dashboardGate/1v1_1.png" alt="1v1">
                                <button>Play</button>
                                <h1> 1 Vs 1 </h1>
                            </div>
                            <div class="2v2">
                                ...
                                <h1> 2 Vs 2 </h1>
                                <img src="https://localhost/assets/images/dashboardGate/2v2.png" alt="2v2">
                                <button>Play</button>
                                <h1> 2 Vs 2 </h1>
                            </div>
                            <div class="tournament">
                                ...
                                <h1> Tournament </h1>
                                <img src="https://localhost/assets/images/dashboardGate/tournament.png" alt="tournament">
                                <button>Enter</button>
                                <h1> Tournament </h1>
                            </div>
                            <div class="1vbot">
                                ...
                                <h1> Vs Bot </h1>
                                <img src="https://localhost/assets/images/dashboardGate/r2.png" alt="1vbot">
                                <button>Train</button>
                                <h1> Vs Bot </h1>
                            </div>
                            <span class="bob">
                                <img src="https://localhost/assets/images/gameGate/tenor.gif" alt="bob">
                            </span>
                        </div>
                    </main>
        </div>
