...
from users.utils import generate_access_token_for_intra42, generate_jwt_access_token, verify_access_token, register_user_intra42, generate_access_token_for_google, register_user_google
...
def intra42_exchange(request):
    ...
    refresh_token = generate_jwt_access_token(code) # code passed to generate the refresh token (random string)
